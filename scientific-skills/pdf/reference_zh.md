...
本文档包含高级 PDF 处理功能、详细示例以及主要技能说明中未涵盖的附加库。

## pypdfium2 库（Apache/BSD 许可证）

### 概述
pypdfium2 是 PDFium（Chromium 的 PDF 库）的 Python 绑定。它擅长快速 PDF 渲染、图像生成，可作为 PyMuPDF 的替代方案。
...
pdf-lib 是一个强大的 JavaScript 库，可在任何 JavaScript 环境中创建和修改 PDF 文档。
...
### 2. 文本提取优化
- `pdftotext -bbox-layout` 是纯文本提取的最快方案
...
- **pypdf**: BSD 许可
- **pdfplumber**: MIT 许可
- **pypdfium2**: Apache/BSD 许可
- **reportlab**: BSD 许可
- **poppler-utils**: GPL-2 许可
- **qpdf**: Apache 许可
- **pdf-lib**: MIT 许可
- **pdfjs-dist**: Apache 许可
